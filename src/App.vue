...
<template>
    ...
    <div id="navmenu">
      ...
      <nav
        ...
        style="background: linear-gradient(to top left, #61b89d, #b1eeb5)"
      >
      ...
      <!-- product -->
       <div class="shoes">
            <div class="container" style="margin-block: 60px;">
                <div class="row">
                    <div class="col-md-3 d-flex justify-content-center list-product">
                        <div class="p-5 text-light">
                            <div class="shoe-nike">
                                <div class="icon">
                                    ...
                                    <a class="icon-tym" href="#">
                                        <i class="bi bi-heart"></i>
                                    </a>
                                </div>
                                <div class="name">
                                    NIKE - WHITE x AIR JORDAN-1
                                </div>
                                <div class="year">
                                    2024
                                </div>
                                <div class="image">
                                    <a href=""><img src="image/GiayTrangDen.png" class="img img-fluid"
                                            alt="ShoeTrangDen"></a>
                                </div>
                                <div class="footshoe">
...
<!-- about -->
    <div class="about" id="About">
      ...
      <img src="image/den1.png" class="thumbnail" @click="functio">
      <img src="image/den2.png" class="thumbnail" @click="functio">
      <img src="image/den3.png" class="thumbnail" @click="functio">
      <img src="image/den4.png" class="thumbnail" @click="functio">
    </div>
    ...
    <!--Services-->
    <div class="services mt-5" id="Servises">
        <div class="services_font margin-top:100px">
        ...
        <div class="container services_cards my-5">
            <div class="row services1 servicess">
                ...
                <div class="col-4">
                    <div class="vienkimcuong"
                        style="text-align: center; font-size: 50px; font-weight: bold; margin-bottom: 20px;">
                        <i class="bi bi-truck"></i>
                    </div>
                    <h4 style="text-align: center;">Fast Delivery</h4>
                    <p style="text-align: center; color: white;">Lorem ipsum dolor, sit amet consectetur adipisicing
                        elit.</p>
                </div>
                <div class="col-4">
                    <div class="gift"
        ...
        <div class="container">
            <div class="row services2 servicess">
                <div class="col-4">
                    ...
                    <p style="text-align: center; color: white;">Lorem ipsum dolor, sit amet consectetur adipisicing
                        elit. Ab sequi dignissimos ullam fuga placeat qui tempore exercitationem dolor voluptatum
                        facilis ratione, recusandae voluptas maxime dolore optio in. Ipsum, omnis architecto!</p>
                </div>
                <div class="col-4">
        ...
        <div class="Claritas">
            <div class="container textClaritas">
                <div class="text-claritas">

                    <i style="color: rgb(243, 245, 249); text-align: center;">
                        Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum.
                        Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit
                        litterarum formas
                    </i>
                </div>
                <h5 class="pt-3 pb-5" style="text-align: center;">KEVIN LEE AT WALL STREET - NEW YORK</h5>
    ...
    <footer>
        <div class="footer_main">
            <div class="tag">
                <h1>Contact</h1>
                <a href="#"><i class="bi bi-house"></i>Tăng Nhơn Phú A, Thành Phố Thủ Đức, TP Hồ Chí Minh</a>
